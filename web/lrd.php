...
<br>
<center>
<h1 style="font-family:Trebuchet MS;font-size:250%">LOST REQUESTS</h1>
</center>
...
while($row = mysqli_fetch_array($result))
{
    ...
    elseif ($row["LOSTREQ"] >= 10 and $row["LOSTREQ"] < 100)
    {
     $color_class = 'orange';
    }
     else
...
<div class="right">
	...
	<h2 style="font-family:Trebuchet MS;font-size:90%;">
		<p> GREEN: Less Than 10 Req/sec </p>
	</h2>
	
	<h2 style="font-family:Trebuchet MS;font-size:90%;">
		<p> ORANGE: In Between 10 Req/sec - 100 Req/sec </p>
	</h2>

	<h2 style="font-family:Trebuchet MS;font-size:90%;">
		<p> RED: Greater Than 100 Req/sec </p>
	</h2>
